    ...
    if (o.scriptPubKey.asm.indexOf("SSGEN") > -1 ) {
        ...
        if (config.network == 'dcrdlivenet') {
          ...
          if (parseInt(hexLE, 16) == 4) {
            ...
            var dcp0004Mask=0x06;
            var choice = 'DCP0004: ';
            switch (parseInt(agendasLE, 16)&dcp0004Mask) { case 0x02: choice += 'no';break;  case 0x04: choice +='yes';break;  default: choice+='abstain'; }
            if (choice != '') {
              info.agendas.push(choice);
            }
          } else {
